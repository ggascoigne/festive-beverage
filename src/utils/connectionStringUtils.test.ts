...
describe('connectionStringUtils', () => {
  ...
  describe('recreatePostgresConnectionString', () => {
    ...
    // ADMIN_DATABASE_URL="postgres://acnw:probity-metro-partisan@acnw.cgp1s0yy6v94.us-west-2.rds.amazonaws.com:5432/festbev?sslmode=verify-full&ssl=1&sslrootcert=/tmp/rds-cert.pem"
